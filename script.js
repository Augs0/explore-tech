  ...
  creativeJobs: [
    {
      ...
      skills:
        'Sketch or other wireframing tools like Adobe XD or Figma, Photoshop, Writing and research skills',
    },
  ],
  safetyJobs: [
    {
  ...
  businessJobs: [
    {
      ...
      skills:
        'Technical skills can be very helpful in this role. You may find some individuals move into this kind of work after working in development themselves, but generally speaking, alongside the research and presentation skills required in this kind of work, business intelligence analysts may need skills in database management, languages like SQL, and understanding of related tools like PowerBI and SAS.',
    },
    {
      role: 'Consultant',
...
function showContent(contentTopic){
  suggestionsBox.innerHTML = '';
  const selectedJobs = jobs[contentTopic];
